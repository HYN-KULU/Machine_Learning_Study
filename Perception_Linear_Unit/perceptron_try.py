...
class Perceptron(object):
    ...
    def _one_iteration(self, input_vecs, labels, rate):
        ...
        for (input_vec, label) in samples:
            ...
            self._update_weights_bias(input_vec, output, label, rate)

    def _update_weights_bias(self, input_vec, output, label, rate):
        """
        按照感知器规则更新权重
        """
        # 首先计算本次更新的delta
...
if __name__ == '__main__':
    ...
    print(perception)
    print('1 and 1 = {}\n'.format(perception.predict([1, 1])))
    print('1 and 0 = {}\n'.format(perception.predict([1, 0])))
    print('0 and 1 = {}\n'.format(perception.predict([0, 1])))
    print('0 and 0 = {}\n'.format(perception.predict([0, 0])))
